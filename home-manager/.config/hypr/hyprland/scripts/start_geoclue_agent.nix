...
{
  home.file.".config/hypr/hyprland/scripts/start_geoclue_agent.sh".text = ''
    #!/usr/bin/env bash
  ...
  home.activation.makeGeoClueExecutable = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
    chmod +x ${config.home.homeDirectory}/.config/hypr/hyprland/scripts/start_geoclue_agent.sh
  '';
}
