...
background {
    blur = true
    #blur_size = 8              # You can tweak this for strength
    blur_passes = 3            # As you included
    ignore_alpha = false       # Necessary to respect the alpha in rgba
    color = rgba(0, 0, 0, 0.3) # ~30% opaque black
}
