  ...
  config = {
    systemd.services.periphery = {
      ...
      serviceConfig = {
        ...
        ExecStart = "/run/current-system/sw/bin/docker compose -f /swarm/periphery/compose.yaml up";
        ExecStop = "/run/current-system/sw/bin/docker compose -f /swarm/periphery/compose.yaml down";
